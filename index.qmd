...
What's the "shape" of employment in North Carolina, and how has it changed over the last two decades? The US Census County Business Patterns (CBP) provides data that helps to answer these questions.
...
The data is sourced and processed as follows:
...
Special thanks to the US Census staff for producing high-quality data over long time periods. Also shout-out to Jeremy Singer-Vines for highlighting this data in his Data is Plural newsletter [2023.05.31 edition](https://www.data-is-plural.com/archive/2023-05-31-edition/) .

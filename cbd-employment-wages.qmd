...
data_for_plot <- d_emp_sector_total_county |>
...
data_for_plot <- d_emp_sector_total_state_nc |> # d_sector_totals_state |>
  #mutate(pct_emp = emp / sum(emp)) |>
...
***TODO: switch df I use and make sure avg_wage is available***
...
d_emp_sector_total_state_nc |>
  filter(year == 2021) |>
  select(naics, naics_abbr, naics_descr, emp, pct_emp) |>
  arrange(-emp) |>
  mutate(rowid = row_number()) |>
